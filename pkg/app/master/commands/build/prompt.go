...
var CommandFlagSuggestions = &commands.FlagSuggestions{
	Names: []prompt.Suggest{
		...
		{Text: commands.FullFlagName(commands.FlagEnableMondelLogs), Description: commands.FlagEnableMondelLogsUsage},
	...
	Values: map[string]commands.CompleteValue{
		...
		commands.FullFlagName(commands.FlagEnableMondelLogs):               commands.CompleteBool,
