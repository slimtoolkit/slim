...
var CommandFlagSuggestions = &commands.FlagSuggestions{
	Names: []prompt.Suggest{
		...
		{Text: commands.FullFlagName(FlagIncludeNuxtAll), Description: FlagIncludeNuxtAllUsage},
		{Text: commands.FullFlagName(FlagIncludeNuxtBuildDir), Description: FlagIncludeNuxtBuildDirUsage},
		{Text: commands.FullFlagName(FlagIncludeNuxtDistDir), Description: FlagIncludeNuxtDistDirUsage},
	...
	Values: map[string]commands.CompleteValue{
		...
		commands.FullFlagName(FlagIncludeNuxtAll):                          commands.CompleteBool,
		commands.FullFlagName(FlagIncludeNuxtBuildDir):                     commands.CompleteBool,
		commands.FullFlagName(FlagIncludeNuxtDistDir):                      commands.CompleteBool,
