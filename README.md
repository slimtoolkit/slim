...
Latest version: 1.35.1 (4/27/2021)

This release add many new `xray` capabilities, a number of application probing enhancements, many new build, runtime and optimization flags and colors for the console output.
...
1. Download the zip package for your platform.
   ...
   - [Latest Mac binaries](https://downloads.dockerslim.com/releases/1.35.1/dist_mac.zip)

   - [Latest Linux binaries](https://downloads.dockerslim.com/releases/1.35.1/dist_linux.tar.gz)

   - [Latest Linux ARM binaries](https://downloads.dockerslim.com/releases/1.35.1/dist_linux_arm.tar.gz)

   - [Latest Linux ARM64 binaries](https://downloads.dockerslim.com/releases/1.35.1/dist_linux_arm64.tar.gz)
...
1. Get the docker-slim [Mac](https://downloads.dockerslim.com/releases/1.35.1/dist_mac.zip), [Linux](https://downloads.dockerslim.com/releases/1.35.1/dist_linux.tar.gz), [Linux ARM](https://downloads.dockerslim.com/releases/1.35.1/dist_linux_arm.tar.gz) or [Linux ARM64](https://downloads.dockerslim.com/releases/1.35.1/dist_linux_arm64.tar.gz) binaries. Unzip them and optionally add their directory to your PATH environment variable if you want to use the app from other locations.
