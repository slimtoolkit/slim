...
1. Download the zip package for your platform.
   - [Latest Mac binaries](https://github.com/cloudimmunity/docker-slim/releases/download/v1.13/dist_mac.zip)
   - [Latest Linux binaries](https://github.com/cloudimmunity/docker-slim/releases/download/v1.13/dist_linux.zip)
2. Unzip the package.
...
0. Get the docker-slim [Mac](https://github.com/cloudimmunity/docker-slim/releases/download/v1.13/dist_mac.zip) or [Linux](https://github.com/cloudimmunity/docker-slim/releases/download/v1.13/dist_linux.zip) binaries. Unzip them and optionally add their directory to your PATH environment variable if you want to use the app from other locations.
...
* `--http-probe-cmd` - zero or more HTTP probe commands
...
* `--mount` - mount volume analyzing image (the mount parameter format is identical to the `-v` mount command in Docker)
