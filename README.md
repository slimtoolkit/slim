...
0. Get the docker-slim [Mac](https://github.com/cloudimmunity/docker-slim/releases/download/v1.12/dist_mac.zip) or [Linux](https://github.com/cloudimmunity/docker-slim/releases/download/v1.12/dist_linux.zip) binaries. Unzip them and optionally add their directory to your PATH environment variable if you want to use the app from other locations.
